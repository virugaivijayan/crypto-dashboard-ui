      ...
      <Card className="shadow-xl rounded-2xl">
        <CardContent className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>📈 <strong>Price:</strong> $62,540.50</div>
            <div>📉 <strong>RSI:</strong> 27.45 (Oversold)</div>
            <div>📊 <strong>MACD:</strong> Bearish</div>
            <div>🟢 <strong>Signal:</strong> <span className="text-green-600 font-bold">BUY ✅</span></div>
            <div>⏱️ <strong>Time:</strong> 2:03 PM</div>
            <div>📤 <strong>Triggered:</strong> Yes</div>
          </div>
